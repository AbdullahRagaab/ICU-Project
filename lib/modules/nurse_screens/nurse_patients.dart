...
import 'package:icu_project/modules/animation/page_fade_animation.dart';
import 'package:icu_project/modules/search/patient(n)_search_screen.dart';
...
class NursePatientScreen extends StatefulWidget {
  const NursePatientScreen({Key? key}) : super(key: key);
...
class _NursePatientScreenState extends State<NursePatientScreen> {
  ...
  void initState() {
    ...
    UserSignUpCubit.getCubit(context).getPatientUser(typeEndpoint: 'patient_user/');
  }
      ...
      builder: (BuildContext context, Object? state) {
        ...
        return ConditionalBuilder(
          condition: state is PatientUserScusessState ||
              state is NurseDataScuseesStates,
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: CircleAvatar(
                              ...
                              child: ClipOval(
                                child: Image(
                                  image: getCubit.getNurseData?.data?.gender ==
                                              "female" ||
                                          getCubit.getNurseData?.data?.gender ==
                                              "Female"
                                      ? const AssetImage(
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.of(context).push(
                                PageFadeAnimation(const PatientSearchScreen()));
                          },
                        ),
                        IconButton(
                          icon: Icon(
