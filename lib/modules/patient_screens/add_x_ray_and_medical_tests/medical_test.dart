...
class MedicalTestScreen extends StatefulWidget {
  ...
  @override
  MedicalTestScreenState createState() => MedicalTestScreenState();
}

class MedicalTestScreenState extends State<MedicalTestScreen> {
  var selectedDate;
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<XRayCubit, XRayStates>(
      ...
      if (state is AddMedicalTestScusessState) {
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                              ...
                              child: Padding(
                                ...
                                child: SizedBox(
                                    ...
                                    child: TextFormField(
                                      ...
                                      validator: (value) {
                                        if (value!.isEmpty) {
                                          return 'Medical Test field mustn\'t be empty';
                                        }
                                      },
                  ...
                  ConditionalBuilder(
                    condition: state is! AddMedicalTestLoadingState,
                    ...
                    fallback: (context) {
                      if (state is AddMedicalTestErrorState) {
                        String errorMessage =
