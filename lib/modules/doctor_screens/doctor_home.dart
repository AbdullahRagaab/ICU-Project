      ...
      builder: (context, state) {
        return Scaffold(
          body: ConditionalBuilder(
            condition: state is DoctorDataScuseesStates,
            builder: (context) {
                ...
                child: Column(
                  children: [
                    ...
                    defaultAboutMeInformation(
                      ...
                      mainText: 'Name',
                      data: getCubit.getDoctorData!.data!.name!,
                    ),
                    const SizedBox(
                      height: 30,
                    ),
                    ...
                    defaultAboutMeInformation(
                      ...
                      mainText: 'Email',
                      data: getCubit.getDoctorData!.data!.email!,
                    ),
                    const SizedBox(
                      height: 30,
                    ),
                    ...
                    defaultAboutMeInformation(
                      ...
                      mainText: 'Phone',
                      data: getCubit.getDoctorData!.data!.phone!,
                    ),
                    const SizedBox(
                      height: 30,
                    ),
                    defaultAboutMeInformation(
                      ...
                      mainText: 'Address',
                      data: getCubit.getDoctorData!.data!.address!,
                    ),
                    const SizedBox(
                      height: 30,
                    ),
                    defaultAboutMeInformation(
                      ...
                      mainText: 'ID',
                      data: getCubit.getDoctorData!.data!.natId!,
                    ),
                    const SizedBox(
                      height: 30,
                    ),
                    defaultAboutMeInformation(
                      ...
                      mainText: 'Specialist',
                      data: getCubit.getDoctorData!.data!.specialization!,
                    ),
                    const SizedBox(
                      height: 30,
                    ),
                    defaultAboutMeInformation(
                      ...
                      mainText: 'Status',
                      data: getCubit.getDoctorData!.data!.status!,
                    ),
                    const SizedBox(
                      height: 30,
                    ),
                    defaultAboutMeInformation(
                      ...
                      mainText: 'Gender',
                      data: getCubit.getDoctorData!.data!.gender!,
                    ),
                    const SizedBox(
                      height: 30,
                    ),
                    defaultAboutMeInformation(
                      ...
                      mainText: 'Age',
                      data: getCubit.getDoctorData!.data!.age!,
                    ),
                  ],
                ),
              );
