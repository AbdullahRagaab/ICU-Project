...
class DoctorNotificationDetailsScreen extends StatefulWidget {
  int? notificationID, index;
  DoctorNotificationDetailsScreen({Key? key, this.notificationID, this.index})
      : super(key: key);

  @override
  State<DoctorNotificationDetailsScreen> createState() =>
      _DoctorNotificationDetailsScreenState();
}

class _DoctorNotificationDetailsScreenState
    extends State<DoctorNotificationDetailsScreen> {
  @override
  void initState() {
    super.initState();
        ...
        if (state is GetNotificationScuseesStates) {
          Fluttertoast.showToast(
            ...
            fontSize: 16.0,
              ...
              context,
              MaterialPageRoute(
                builder: (context) => const DoctorNotificationScreen(),
              )));
        }
      },
