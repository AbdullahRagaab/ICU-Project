...
class AddHeadNurse extends StatefulWidget {
  const AddHeadNurse({Key? key}) : super(key: key);

  @override
  AddHeadNurseState createState() => AddHeadNurseState();
}

class AddHeadNurseState extends State<AddHeadNurse> {
      ...
      listener: (BuildContext context, state) {
        if (state is SignUpScusessState) {
          Fluttertoast.showToast(
              msg: "HeadNursing Added Scussesfully",
