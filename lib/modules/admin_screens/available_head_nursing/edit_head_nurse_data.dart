...
class EditHeadNursingScreen extends StatefulWidget {
  String? name,
      username,
      id,
      email,
  ...
  @override
  State<EditHeadNursingScreen> createState() => _EditHeadNursingScreenState();
}

class _EditHeadNursingScreenState extends State<EditHeadNursingScreen> {
  ...
  void initState() {
    ...
    UserSignUpCubit.getCubit(context)
        .getHeadNursing(typeEndpoint: 'headnursing');
  }
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<UserSignUpCubit, UserSignUpStates>(
      ...
      builder: (context, state) {
        ...
        rollController.text = "headnursing";
