...
class AddNurse extends StatefulWidget {
  const AddNurse({Key? key}) : super(key: key);

  @override
  AddNurseState createState() => AddNurseState();
}

class AddNurseState extends State<AddNurse> {
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: DropdownButtonFormField2(
                            ...
                            validator: (value) {
                              if (value == null) {
                                return 'Please select your specialist';
                              }
                            },
                            onChanged: (value) {
