...
import 'package:icu_project/modules/doctor_screens/doctor_patients.dart';
...
class DoctorPatientSearchScreen extends StatefulWidget {
  const DoctorPatientSearchScreen({Key? key}) : super(key: key);
              ...
              child: IconButton(
                onPressed: () {
                   Navigator.of(context).pop(
                                PageFadeAnimation(const DoctorPatientScreen()));
                },
